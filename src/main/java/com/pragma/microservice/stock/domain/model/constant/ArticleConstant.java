...
public class ArticleConstant {
    ...
    public static final String BRAND_CANNOT_BE_NULL = "The field 'brand' can't be null";
    public static final String ARTICLE_AMOUNT_CANNOT_BE_NEGATIVE = "The field 'amount' can't be negative";
    public static final String ARTICLE_PRICE_CANNOT_BE_NEGATIVE = "The field 'price' can't be negative";
    public static final String ARTICLE_SORT_BY_FIELDS = "The field 'sortBy' only can be 'name' 'price' 'amount'";
}
